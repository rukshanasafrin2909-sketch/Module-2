...
print(f"You have {original_count} chores to finish today! Lets Start\n")
...
while chore_num <= total_chores:
    ...
    if chore_num == 1: next_chore = "Clean your room"
    elif chore_num == 2: next_chore = "Feed the cat"
    elif chore_num == 3: next_chore = "Complete your homework"
    elif chore_num == 4: next_chore = "Help your mum"
